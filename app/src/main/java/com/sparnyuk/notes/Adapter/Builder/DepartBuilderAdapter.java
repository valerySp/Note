...
import com.sparnyuk.notes.DEPART.Builder.UpdateBuilder;

import com.sparnyuk.notes.ModelRecord;
import com.sparnyuk.notes.R;
import com.sparnyuk.notes.TITLE.Builder.ListTitleBuilder;


import java.util.ArrayList;

public class DepartBuilderAdapter extends RecyclerView.Adapter<DepartBuilderAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordList;
    private DBHelperBuilder db;

    public DepartBuilderAdapter(Context context, ArrayList<ModelRecord> recordList) {
        this.context = context;
        this.recordList = recordList;
        db =new DBHelperBuilder(context);
    }
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ListTitleBuilder.class);
            ...
            public void onClick(View v) {
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==1){
                            db.delDepartBuilder(departa);
                            ((ShowDepartBuilder)context).onResume();
                        }
                        else if (which==0){
                            Intent intent=new Intent(context, UpdateBuilder.class);
