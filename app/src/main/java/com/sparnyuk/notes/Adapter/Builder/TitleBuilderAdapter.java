...
import com.sparnyuk.notes.TITLE.Builder.ShowTitleBuilder;


import java.util.ArrayList;

public class TitleBuilderAdapter extends RecyclerView.Adapter<TitleBuilderAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordTitleList;
    private DBHelperBuilder db;

    public TitleBuilderAdapter(Context context, ArrayList<ModelRecord> recordList) {
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ShowTitleBuilder.class);
            ...
            public void onClick(View v) {
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0){
                            db.delTitleBuilder(departa,title);
                            ((ListTitleBuilder)context).onResume();
                        }
                        if (which==1){
