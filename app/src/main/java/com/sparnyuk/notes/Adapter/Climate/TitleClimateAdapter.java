...
import com.sparnyuk.notes.TITLE.Climate.ShowTitleClimate;


import java.util.ArrayList;

public class TitleClimateAdapter extends RecyclerView.Adapter<TitleClimateAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordTitleList;
    private DBHelperClimate db;

    public TitleClimateAdapter(Context context, ArrayList<ModelRecord> recordList) {
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ShowTitleClimate.class);
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0){
                            ...
                            ((ListTitleClimate)context).onResume();
                        }
                        if (which==1){
