...
import com.sparnyuk.notes.TITLE.ETK.ShowTitleETK;


import java.util.ArrayList;

public class TitleETKAdapter extends RecyclerView.Adapter<TitleETKAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordTitleList;
    private DBHelperETK db;

    public TitleETKAdapter(Context context, ArrayList<ModelRecord> recordList) {
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ShowTitleETK.class);
            ...
            public void onClick(View v) {
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0){
                            db.delTitleETK(departa,title);
                            ((ListTitleETK)context).onResume();
                        }
                        if (which==1){
