...
public class ImageGasAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ModelRecord> recordList;
    DBHelperGas db1; //delete private

    public ImageGasAdapter(Context c, ArrayList<ModelRecord> recordList) {
        this.context = c;
        this.recordList = recordList;
        db1 = new DBHelperGas(context);
    }
