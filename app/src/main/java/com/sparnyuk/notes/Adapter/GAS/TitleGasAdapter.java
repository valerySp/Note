...
import com.sparnyuk.notes.TITLE.GAS.ShowTitleGas;

import java.util.ArrayList;

public class TitleGasAdapter extends RecyclerView.Adapter<TitleGasAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordTitleList;
    private DBHelperGas dbHelperGas;

    public TitleGasAdapter(Context context, ArrayList<ModelRecord> recordList) {
        this.context = context;
        this.recordTitleList = recordList;
        dbHelperGas = new DBHelperGas(context);
    }
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ShowTitleGas.class);
            ...
            public void onClick(View v) {
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0){
                            dbHelperGas.delTitle(departa,title);
                            ((ListTitleGas)context).onResume();
                        }
                        if (which==1){
