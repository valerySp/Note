...
import com.sparnyuk.notes.TITLE.Otdel.ShowTitleOtdel;


import java.util.ArrayList;

public class TitleOtdelAdapter extends RecyclerView.Adapter<TitleOtdelAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordTitleList;
    private DBHelperOtd db;

    public TitleOtdelAdapter(Context context, ArrayList<ModelRecord> recordList) {
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ShowTitleOtdel.class);
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0){
                            ...
                            ((ListTitleOtdel)context).onResume();
                        }
                        if (which==1){
