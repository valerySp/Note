package com.sparnyuk.notes.Adapter.Other;
...
import com.sparnyuk.notes.DEPART.Water.UpdateWater;
import com.sparnyuk.notes.ModelRecord;
import com.sparnyuk.notes.R;
import com.sparnyuk.notes.TITLE.Other.ListTitleOther;
import com.sparnyuk.notes.TITLE.WATER.ListTitleWater;

import java.util.ArrayList;

public class DepartOtherAdapter extends RecyclerView.Adapter<DepartOtherAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordList;
    private DBHelperOther db;

    public DepartOtherAdapter(Context context, ArrayList<ModelRecord> recordList) {
        this.context = context;
        this.recordList = recordList;
        db =new DBHelperOther(context);
    }
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ListTitleOther.class);
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==1){
                            ...
                            ((ShowDepartOther)context).onResume();
                        }
                        else if (which==0){
                            Intent intent=new Intent(context, UpdateWater.class);
