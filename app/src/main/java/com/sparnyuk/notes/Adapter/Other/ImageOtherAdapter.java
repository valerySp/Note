...
public class ImageOtherAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ModelRecord> recordList;
    DBHelperOther db1; //delete private

    public ImageOtherAdapter(Context c, ArrayList<ModelRecord> recordList) {
        this.context = c;
        this.recordList = recordList;
        db1 = new DBHelperOther(context);
    }
