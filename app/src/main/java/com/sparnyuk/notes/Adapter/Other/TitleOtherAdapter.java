...
import com.sparnyuk.notes.TITLE.Other.ShowTitleOther;


import java.util.ArrayList;

public class TitleOtherAdapter extends RecyclerView.Adapter<TitleOtherAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordTitleList;
    private DBHelperOther db;

    public TitleOtherAdapter(Context context, ArrayList<ModelRecord> recordList) {
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ShowTitleOther.class);
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0){
                            ...
                            ((ListTitleOther)context).onResume();
                        }
                        if (which==1){
