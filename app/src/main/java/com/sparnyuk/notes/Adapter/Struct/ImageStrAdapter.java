...
public class ImageStrAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ModelRecord> recordList;
    DBHelperStr db1; //delete private

    public ImageStrAdapter(Context c, ArrayList<ModelRecord> recordList) {
        this.context = c;
        this.recordList = recordList;
        db1 = new DBHelperStr(context);
    }
