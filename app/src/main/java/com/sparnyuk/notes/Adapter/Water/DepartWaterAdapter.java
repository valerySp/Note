...
public class DepartWaterAdapter extends RecyclerView.Adapter<DepartWaterAdapter.HolderRecord> {

    private Context context;
    private ArrayList<ModelRecord> recordList;
    private DBHelperWater db;

    public DepartWaterAdapter(Context context, ArrayList<ModelRecord> recordList) {
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ListTitleWater.class);
                ...
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==1){
                            ...
                            ((ShowDepartWater)context).onResume();
                        }
                        else if (which==0){
