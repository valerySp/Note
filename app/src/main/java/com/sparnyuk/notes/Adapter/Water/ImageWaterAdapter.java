...
public class ImageWaterAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ModelRecord> recordList;
    DBHelperWater db1; //delete private

    public ImageWaterAdapter(Context c, ArrayList<ModelRecord> recordList) {
        this.context = c;
        this.recordList = recordList;
        db1 = new DBHelperWater(context);
    }
