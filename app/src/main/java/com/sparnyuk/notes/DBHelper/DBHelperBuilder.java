...
public class DBHelperBuilder extends SQLiteOpenHelper {

    public DBHelperBuilder(@Nullable Context context) {
    ...
    public long insertTitle(String depart, String image, String title, String discr, String addtime, String galery){
        ...
        long id=db.insert(Constant.TABLE_NAME_DEV,null,values);
        db.close();
        return id;
    }

    public long insertDepartBuilder(String depart, String image){
        //,String addtime, String update
        SQLiteDatabase db=this.getWritableDatabase();
        ContentValues values =new ContentValues();
        values.put(Constant.KEY_DEPARTMENT,depart);
    ...
    public ArrayList<ModelRecord> getDepartNameBuilder(String orderBy){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="SELECT * FROM "+Constant.TABLE_NAME_DEV+" WHERE "+Constant.KEY_TITLE+
    ...
    public ArrayList<ModelRecord> getPictureBuilder(String depart, String title){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="SELECT "+ Constant.KEY_IMAGE_GALLERY+","+Constant.KEY_TIME_ADD+" FROM "+Constant.TABLE_NAME_DEV+" WHERE "+Constant.KEY_DEPARTMENT+
    ...
    public ArrayList<ModelRecord> getRecTitleBuilder(String depart, String orderBy){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="SELECT * FROM "+Constant.TABLE_NAME_DEV+" WHERE "+Constant.KEY_DEPARTMENT+
    ...
    public ArrayList<ModelRecord> getUpDateTitleBuilder(String selection, String tilte, String discr, String addtime){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="UPDATE "+Constant.TABLE_NAME_DEV+
                " SET "
    ...
    public ArrayList<ModelRecord> updateTitleNotiBuilder (String id, String addNoti){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="UPDATE "+Constant.TABLE_NAME_DEV+
    ...
    public ArrayList<ModelRecord> deleteGalleryBuilder(String gallery, String title){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="DELETE FROM "+Constant.TABLE_NAME_DEV+
    ...
    public ArrayList<ModelRecord> getUpDateDepartBuilder(String selection, String depart, String image){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="UPDATE "+Constant.TABLE_NAME_DEV+
                " SET "
                ...
                " WHERE "+Constant.KEY_ID+" =\'"+selection+"\'";
    ...
    public ArrayList<ModelRecord> delDepartBuilder(String depart){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="DELETE FROM "+Constant.TABLE_NAME_DEV+
    ...
    public ArrayList<ModelRecord> delTitleBuilder(String depart, String title){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="DELETE FROM "+Constant.TABLE_NAME_DEV+
    ...
    public ArrayList<ModelRecord> searchRecords(String query, String depart){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="SELECT * FROM "+Constant.TABLE_NAME_DEV+" WHERE "+
