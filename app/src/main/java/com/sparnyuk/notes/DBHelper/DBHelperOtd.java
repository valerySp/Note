...
public class DBHelperOtd extends SQLiteOpenHelper {

    public DBHelperOtd(@Nullable Context context) {
    ...
    public long insertTitle(String depart, String image, String title, String discr, String addtime, String galery){
        ...
        long id=db.insert(Constant.TABLE_NAME_OTD,null,values);
        db.close();
        return id;
    }
    ...
    public ArrayList<ModelRecord> getDepartName(String orderBy){
        ...
        String selectQuery="SELECT * FROM "+Constant.TABLE_NAME_OTD+" WHERE "+Constant.KEY_TITLE+
    ...
    public ArrayList<ModelRecord> getPicture(String depart, String title){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="SELECT "+ Constant.KEY_IMAGE_GALLERY+","+Constant.KEY_TIME_ADD+" FROM "+Constant.TABLE_NAME_OTD+" WHERE "+Constant.KEY_DEPARTMENT+
    ...
    public ArrayList<ModelRecord> getRecTitle(String depart, String orderBy){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="SELECT * FROM "+Constant.TABLE_NAME_OTD+" WHERE "+Constant.KEY_DEPARTMENT+
    ...
    public ArrayList<ModelRecord> getUpDateTitle(String selection, String tilte, String discr, String addtime){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="UPDATE "+Constant.TABLE_NAME_OTD+
                " SET "
    ...
    public ArrayList<ModelRecord> deleteGallery(String gallery, String title){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="DELETE FROM "+Constant.TABLE_NAME_OTD+
    ...
    public ArrayList<ModelRecord> searchRecords(String query, String depart){
        ArrayList<ModelRecord> recordsList=new ArrayList<>();
        String selectQuery="SELECT * FROM "+Constant.TABLE_NAME_OTD+" WHERE "+
