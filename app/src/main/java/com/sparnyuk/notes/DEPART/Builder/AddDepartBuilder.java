...
public class AddDepartBuilder extends AppCompatActivity {
    ...
    private void input() {
        ...
        if (depart.equals("")) {
            ...
            depart = nameDepart.getText().toString();
            db.insertDepartBuilder(""+depart,""+imageUri);
            onBackPressed();
        }
    ...
    public void onBackPressed() {
        startActivity(new Intent(AddDepartBuilder.this, ShowDepartBuilder.class));
    }
}
