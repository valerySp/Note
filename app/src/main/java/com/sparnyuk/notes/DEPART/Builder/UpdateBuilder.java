...
public class UpdateBuilder extends AppCompatActivity {
            ...
            do {
                ...
                if (!departQuery.equals(depart)){
                    if (depart.equals("")){
                        ...
                        db.getUpDateDepartBuilder(""+departQuery,""+departQuery,""+imageUri);
                    } else
                    if (!checkTitle(nameDepart.getText().toString())){
                        db.getUpDateDepartBuilder(""+departQuery,""+departQuery,""+imageUri);
                    }
                    else
                        db.getUpDateDepartBuilder(""+departQuery,""+nameDepart.getText().toString(),""+imageUri);
                }
