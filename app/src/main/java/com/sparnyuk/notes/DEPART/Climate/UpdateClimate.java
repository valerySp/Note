...
public class UpdateClimate extends AppCompatActivity {
            ...
            do {
                ...
                if (!departQuery.equals(depart)){
                    if (depart.equals("")){
                        ...
                        db.getUpDateDepart(""+departQuery,""+departQuery,""+imageUri);
                    } else
                    if (!checkTitle(nameDepart.getText().toString())){
                        db.getUpDateDepart(""+departQuery,""+departQuery,""+imageUri);
                    }
                    else
                        db.getUpDateDepart(""+departQuery,""+nameDepart.getText().toString(),""+imageUri);
                }
