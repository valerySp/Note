...
import com.sparnyuk.notes.Adapter.Builder.ImageBuilderAdapter;
...
public class ImageTitleBuilder extends AppCompatActivity {
    ...
    public void ShowDialogBox(int pos){
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                (ImageTitleBuilder.this).onResume();
                dialog.dismiss();
            }
        });
    }
    ...
    private void loadRecords(String depart,String title) {
        ImageBuilderAdapter adapterRecord=new ImageBuilderAdapter(ImageTitleBuilder.this,
                db.getPictureBuilder(depart,title));
    ...
    public void deleteImage(String gallery,String titleName){
        String timeadd=""+System.currentTimeMillis();
        //titleName=title;
        db.deleteGalleryBuilder(gallery,titleName);
    }
}
