package com.sparnyuk.notes.TITLE.Builder;
...
public class ShowTitleBuilder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveTitleUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.getUpDateTitleBuilder(""+recordID,""+title.getText().toString(),""+desc.getText().toString(),
                        ""+timeadd);
                onBackPressed();
            }
        });
        ...
        openGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ShowTitleBuilder.this, ImageTitleBuilder.class).putExtra("depart",depart)
                        .putExtra("title",title.getText().toString());
                startActivity(intent);
            }
        });

        String selectQuery="SELECT*FROM "+ Constant.TABLE_NAME_DEV+
            ...
            do {
                ...
                if (!nameDesc.equals(desc.getText().toString())||!nameTitle.equals(title.getText().toString())){
                    if (title.getText().toString().equals("")){
                        ...
                        db.getUpDateTitleBuilder(""+nameTitle,""+nameTitle,""+desc.getText().toString(),
                                ""+timeadd);
                    } else
                    if (!checkTitle(title.getText().toString())){
                        ...
                        db.getUpDateTitleBuilder(""+nameTitle,""+title.getText().toString(),""+desc.getText().toString(),
                                ""+timeadd);
                }
            } while (cursor.moveToNext());
        }
