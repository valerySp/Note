...
import com.sparnyuk.notes.Adapter.Climate.ImageClimateAdapter;
...
public class ImageTitleClimate extends AppCompatActivity {
    ...
    public void ShowDialogBox(int pos){
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                (ImageTitleClimate.this).onResume();
                dialog.dismiss();
            }
        });
    }
    ...
    private void loadRecords(String depart,String title) {
        ImageClimateAdapter adapterRecord=new ImageClimateAdapter(ImageTitleClimate.this,
