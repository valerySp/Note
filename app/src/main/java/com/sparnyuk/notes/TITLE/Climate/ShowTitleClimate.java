...
public class ShowTitleClimate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ShowTitleClimate.this, ImageTitleClimate.class).putExtra("depart",depart)
                        .putExtra("title",title.getText().toString());
                startActivity(intent);
            }
        });

        String selectQuery="SELECT*FROM "+ Constant.TABLE_NAME_CLIMATE+
