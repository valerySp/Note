...
public class AddTitleETK extends AppCompatActivity {
        ...
        nameDesc = desc.getText().toString();
            if (nameTitle.equals("") || nameDesc.equals("")) {
                ...
                if (imageUriTitle==null){
                    long id = db.insertTitleETK("" + depart, "" + null, "" + nameTitle, "" + nameDesc, "" + timeadd, "" + null);
                    onBackPressed();
                }
                else{
                    long id = db.insertTitleETK("" + depart, "" + null, "" + nameTitle, "" + nameDesc, "" + timeadd, "" + null);
                    db.insertTitleETK("" + depart, "" + null, "" + nameTitle, "" + null, "" + timeadd, "" + imageUriTitle);
