...
import com.sparnyuk.notes.Adapter.ETK.ImageETKAdapter;
...
public class ImageTitleETK extends AppCompatActivity {
    ...
    private void loadRecords(String depart,String title) {
        ImageETKAdapter adapterRecord=new ImageETKAdapter(ImageTitleETK.this,
                db.getPictureETK(depart,title));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode==RESULT_OK&&requestCode==IMAGE_PICK_GALLERY_CODE_TITLE&&data!=null){
            ...
            long id= db.insertTitleETK(""+depart,""+null,""+title,""+null,""+timeadd,""+imageUriTitle);
    ...
    public void deleteImage(String gallery,String titleName){
        String timeadd=""+System.currentTimeMillis();
        //titleName=title;
        db.deleteGalleryETK(gallery,titleName);
    }
}
