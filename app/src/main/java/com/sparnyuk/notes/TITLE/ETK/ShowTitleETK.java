...
public class ShowTitleETK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveTitleUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.getUpDateTitleETK(""+recordID,""+title.getText().toString(),""+desc.getText().toString(),
                        ""+timeadd);
                onBackPressed();
            }
        });
        ...
        openGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ShowTitleETK.this, ImageTitleETK.class).putExtra("depart",depart)
            ...
            do {
                ...
                if (!nameDesc.equals(desc.getText().toString())||!nameTitle.equals(title.getText().toString())){
                    if (title.getText().toString().equals("")){
                        ...
                        db.getUpDateTitleETK(""+nameTitle,""+nameTitle,""+desc.getText().toString(),
                                ""+timeadd);
                    } else
                    if (!checkTitle(title.getText().toString())){
                        ...
                        db.getUpDateTitleETK(""+nameTitle,""+title.getText().toString(),""+desc.getText().toString(),
                                ""+timeadd);
                }
            } while (cursor.moveToNext());
        }
