...
import com.sparnyuk.notes.Adapter.GAS.ImageGasAdapter;
...
public class ImageTitleGas extends AppCompatActivity {
    ...
    private void loadRecords(String depart,String title) {
        ImageGasAdapter adapterRecord=new ImageGasAdapter(ImageTitleGas.this,
