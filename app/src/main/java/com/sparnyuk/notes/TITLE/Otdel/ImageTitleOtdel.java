...
import com.sparnyuk.notes.Adapter.Otdel.ImageOtdelAdapter;
...
public class ImageTitleOtdel extends AppCompatActivity {
    ...
    private void loadRecords(String depart,String title) {
        ImageOtdelAdapter adapterRecord=new ImageOtdelAdapter(ImageTitleOtdel.this,
