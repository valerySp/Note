...
import com.sparnyuk.notes.Adapter.Other.ImageOtherAdapter;
...
public class ImageTitleOther extends AppCompatActivity {
    ...
    private void loadRecords(String depart,String title) {
        ImageOtherAdapter adapterRecord=new ImageOtherAdapter(ImageTitleOther.this,
