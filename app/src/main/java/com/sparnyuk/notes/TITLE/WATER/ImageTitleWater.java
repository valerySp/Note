...
import com.sparnyuk.notes.Adapter.Water.ImageWaterAdapter;
...
public class ImageTitleWater extends AppCompatActivity {
    ...
    private void loadRecords(String depart,String title) {
        ImageWaterAdapter adapterRecord=new ImageWaterAdapter(ImageTitleWater.this,
